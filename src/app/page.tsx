  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-dark via-primary to-primary-light text-white">
        {/* Decorative floating card outlines */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          {/* Subtle radial glow */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgba(212,168,83,0.08)_0%,_transparent_60%)]" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-24 md:py-36 text-center">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-5">
            The smartest way to earn<br />
            <span className="text-gold">rewards in Canada</span>
          </h1>
          ...
          <form onSubmit={handleSearch} className="flex max-w-xl mx-auto shadow-2xl shadow-black/20 rounded-2xl">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-l-2xl border-0 bg-white py-4 pl-12 pr-4 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-gold/50"
              />
            </div>
      ...
      <section className="border-b border-border/50 bg-muted/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-5 flex justify-center gap-10 text-sm font-medium">
          <div className="text-center">
            <p className="text-2xl font-bold text-foreground"><AnimatedCounter end={stats.cards} suffix="+" /></p>
            <p className="text-xs text-muted-foreground mt-0.5">Cards tracked</p>
          </div>
          <div className="w-px bg-border" />
          <div className="text-center">
            <p className="text-2xl font-bold text-foreground"><AnimatedCounter end={stats.issuers} /></p>
            <p className="text-xs text-muted-foreground mt-0.5">Issuers</p>
          </div>
          <div className="w-px bg-border" />
          <div className="text-center">
            <p className="text-2xl font-bold text-foreground"><AnimatedCounter end={2} /></p>
