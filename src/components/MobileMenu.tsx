    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute top-0 left-0 h-full w-72 bg-background shadow-2xl animate-fade-in">
            <div className="flex items-center justify-between p-4 border-b border-border/50">
              <a href="/" className="font-bold text-lg font-[family-name:var(--font-display)]">
                <span className="text-primary">Churning</span><span className="text-gold-text dark:text-gold">Canada</span>
